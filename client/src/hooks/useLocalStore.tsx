...
import { actions as editMessageActions } from '../store/options/editMessage.slice';

import { IMessage, IEditMessage } from '../interfaces/Message.interface';
...
export const useLocalStore = () => {
    ...
    const selectEditMessage = (state: RootState) => state.editMessage;
    const editMessage = useTypedSelector(selectEditMessage);
    const editMessageMode = (editState: IEditMessage) => dispatch(editMessageActions.editMessageMode(editState));
